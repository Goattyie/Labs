...
namespace Kursovaya
{
    class Book : Table
    {
        ...
        public Book(string name, string photo, string description, string lang, int date, string publisher, string style, string binding, int pub_date)
        {
            ...
            Photo = newName;
<<<<<<< HEAD:2.2/DB/Kursovaya/Kursovaya/Tables/Book.cs
=======
            Photo = InputData.CheckString(Photo);
>>>>>>> cd12392bba822688b80fb07e2117a381aa004caa:2.2/DB/Kursovaya/Kursovaya/Kursovaya/Tables/Book.cs
        }
