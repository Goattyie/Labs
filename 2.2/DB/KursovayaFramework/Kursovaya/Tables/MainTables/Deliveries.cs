...
namespace Kursovaya
{
    class Deliveries : MainTable
    {
        ...
        public Deliveries() { }
        public Deliveries(int shop, int book, string lang, int count, string date, double cost, double size, double defcost, bool preorder)
        {
            Shop = shop;
            Book = book;
            Lang = lang;
        ...
        public Deliveries(int id, int shop, int book, string lang, int count, string date, double cost, double size, double defcost, bool preorder)
        {
            Id = id;
            Shop = shop;
            Book = book;
        ...
        protected override string UpdateQuery => $"UPDATE {ClassName} SET id_shop = {Shop}, id_book = {Book}, count_book = {Count}, date_come = {Date}, cost = {Cost}, id_lang = (SELECT id FROM lang WHERE name = {Lang}), size = {Size}, pre_order = {PreOrder}, def_cost = {DefCost} WHERE id = {Id};";
